...
class AbstractEntityModel:
    ...
    def __init__(self, user: str, base: Type[Entity], implementation: type, on_change_callback=None):
        ...
        self.items = self.entity_type.load(self.conn)
...
class NewListModel(QAbstractListModel, AbstractEntityModel):
    INSTANCES = {}

    def __init__(self, user: str, base: Type[Entity]):
        QAbstractListModel.__init__(self)
        AbstractEntityModel.__init__(self, user, base, QAbstractListModel)
