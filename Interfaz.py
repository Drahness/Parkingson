...
from PyQt5.QtWidgets import (
    ...
    QHBoxLayout, QPushButton, QSizePolicy, QTabWidget, QToolBar, QToolButton, QAction, QListWidget, QMessageBox
)
...
class ChronometerWidget(QWidget):
    ...
    def __init__(self, parent):
        ...
        añadir = QIcon("añadir.png")
        delete = QIcon("borrar.png")
        editar = QIcon("editar.png")
        save = QIcon("save.png")
        ...
        content_layout.addWidget(listWidget, stretch=3, alignment=Qt.AlignTop)  #Listado // Quitar el alignment si lo quieres estirado hasta abajo
